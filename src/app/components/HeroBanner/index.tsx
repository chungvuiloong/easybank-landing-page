...
const index = () => {
    return (
        <section className='bg-White overflow-hidden flex flex-row '>
            <div className='container mx-auto'>
                <div className='flex flex-row'>
                    <div className='basis-1/2 flex flex-col justify-center md:gap-6 gap-4'>                
                    ...
                    <div className="basis-1/2 mx-auto -mt-24 max-w-5xl 
